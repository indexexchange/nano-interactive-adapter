...
* `nano-interactive-htb.js` - This is your partner module file, by default it contains a template divided into multiple sections which need to be completed.
* `nano-interactive-htb-validator.js` - This is the validator file for the configuration object that will be passed into your module.
* `nano-interactive-htb-exports.js` - A file that contains all of the modules exports (i.e. any functions that need to be exposed to the outside world).

## <a name='gettingStarted'></a>Getting Started
1. <b>Complete the nano-interactive-htb.js file</b>
    * nano-interactive-htb.js is where all of your adapter code will live.
...
2. <b>Complete the nano-interactive-htb-validator.js file</b>
...
3. <b>Complete the nano-interactive-htb-exports.js file</b>
    * This file will contain any functions that need to be exported or exposed to the outside world. Things like render functions, custom callbacks, etc. Any legacy render functions will also need to be exposed here. Anything added to the `shellInterface.NanoInteractiveHtb` will be accessible through `window.headertag.NanoInteractiveHtb`
...
In this section you will be filling out the nano-interactive-htb.js, nano-interactive-htb-exports.js, and the nano-interactive-htb-validator.js files to create your module.

### Step 0: Config Validation (`nano-interactive-htb-validator.js`)
...
### Step 2: Generate Request URL (`nano-interactive-htb.js`)
...
### Step 3: Response Callback (`nano-interactive-htb.js`)
...
### Step 4: Parsing and Storing Demand (`nano-interactive-htb.js`)
...
```javascript
{
    ...
    "targetingType": "slot"
    "targeting" : {
        "ix_nano_id": ["_230l09jd2"],
        "ix_nano_cpm": ["300x250_2.50"]
    },
    "price": 2.50,
    "size": [300,250],
...
### Step 5: Rendering Pixel (`nano-interactive-htb.js`)
...
### Step 6: Exports (`nano-interactive-htb-exports.js`)
...
```javascript
shellInterface.NanoInteractiveHtb = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'NanoInteractiveHtb')
};
```
...
```javascript
if (__directInterface.Layers.PartnersLayer.Partners.NanoInteractiveHtb) {
    shellInterface.NanoInteractiveHtb = shellInterface.NanoInteractiveHtb || {};
    shellInterface.NanoInteractiveHtb.adResponseCallback = __directInterface.Layers.PartnersLayer.Partners.NanoInteractiveHtb.adResponseCallback;
}
```
...
if (__directInterface.Layers.PartnersLayer.Partners.NanoInteractiveHtb) {
    shellInterface.NanoInteractiveHtb = shellInterface.NanoInteractiveHtb || {};
    shellInterface.NanoInteractiveHtb.adResponseCallbacks = __directInterface.Layers.PartnersLayer.Partners.NanoInteractiveHtb.adResponseCallbacks;
}
```
